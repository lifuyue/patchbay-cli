...
fn aliases(term: &str) -> &'static [&'static str] {
    match term {
        ...
        "rust" => &["cargo", "rs"],
        "cli" => &["command line"],
        "kubernetes" => &["k8s", "helm", "crd", "cluster", "pod", "service discovery"],
        "docker" => &["container", "containerd", "registry"],
        "ci" => &["workflow", "test infra", "test infrastructure"],
        "cloud" => &["ecr", "registry", "replication"],
        ...
        "operator" => &["controller", "crd", "custom resource"],
